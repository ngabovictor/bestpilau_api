...
ROOT_URLCONF = 'bestpilau_api.urls'
...
WSGI_APPLICATION = 'bestpilau_api.wsgi.application'
...
if eval(USE_WHITENOISE):
    STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage'
    STORAGES["staticfiles"]["BACKEND"] = "whitenoise.storage.CompressedManifestStaticFilesStorage"
    

if eval(USE_S3_BOTO3_STORAGE):

    AWS_ACCESS_KEY_ID = os.environ.get('AWS_ACCESS_KEY_ID')
    AWS_SECRET_ACCESS_KEY = os.environ.get('AWS_SECRET_ACCESS_KEY')
    AWS_STORAGE_BUCKET_NAME = os.environ.get('AWS_STORAGE_BUCKET_NAME')
    AWS_S3_ENDPOINT_URL = os.environ.get('AWS_S3_ENDPOINT_URL')
    AWS_S3_CUSTOM_DOMAIN = os.environ.get('AWS_S3_ENDPOINT_URL')
    ...
    STORAGES['default'] = {
            ...
            "OPTIONS": {
                ...
                "endpoint_url": f'https://{AWS_S3_ENDPOINT_URL}',
...
SIMPLE_JWT = {
    ...
    "TOKEN_OBTAIN_SERIALIZER": "authentication.serializers.jwt_serializer.JwtTokenObtainPairSerializer",
